"""Cache-aside middleware for Zork GET responses.
...
from zork.cache.backends import CacheBackend
from zork.cache.invalidation import TAG_PREFIX, _get_key

logger = logging.getLogger("zork.cache.middleware")
