            ...
            <html lang="en">
                <head>
                    ...
                    <style>
                        ...
                        .status {
                            ...
                            font-size: 1.25rem;
                            text-transform: uppercase;
                            box-shadow: 3px 3px 0 var(--blazing-orange);
                        ...
                        @keyframes pulse {
                            0% {
                                box-shadow: 0 0 0 0 rgba(255, 90, 0, 0.8);
                            }
                            70% {
                        ...
                        .links a {
                            ...
                            border: 2px solid var(--charcoal);
                            background: var(--white);
                            box-shadow: 4px 4px 0 var(--blazing-orange);
                            transition: all 0.2s ease;
                        }
                        .links a:hover {
                            transform: translate(-3px, -3px);
                            box-shadow: 7px 7px 0 var(--blazing-orange);
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="links">
                            <a
                                href="https://github.com/blackcoderx/zork"
                                target="_blank"
