"""Core email abstractions for Zork.
...
logger = logging.getLogger("zork.email")
...
class EmailBackend(ABC):
    """Abstract base class for Zork email backends.
    ...
    Example (custom HTTP API backend)::
        ...
        from zork.email import EmailBackend, EmailMessage
        import httpx
