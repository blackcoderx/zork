...
logger = logging.getLogger("zork.email.smtp")
...
class SMTPBackend(EmailBackend):
    ...
    async def send(self, message: EmailMessage) -> None:
        ...
        Raises:
            ImportError: If ``aiosmtplib`` is not installed (``zork[email]`` extra).
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install it with: pip install zork[email]"
            ) from exc
